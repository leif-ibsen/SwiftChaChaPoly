...
//  ChaChaPolyTests
//
//  Created by Leif Ibsen on 21/09/2020.
//
...
class Test1: XCTestCase {
    ...
    func test2() {
        ...
        XCTAssert(aead.decrypt(&t2, tag, aad2))
        XCTAssertEqual(t2, plainText2)
    }
    
    // Test vectors from CryptoSwift

    let key3: Bytes = [
        0x6b, 0x65, 0x79, 0x2e, 0x6b, 0x65, 0x79, 0x2e, 0x6b, 0x65, 0x79, 0x2e, 0x6b, 0x65, 0x79, 0x2e,
        0x6b, 0x65, 0x79, 0x2e, 0x6b, 0x65, 0x79, 0x2e, 0x6b, 0x65, 0x79, 0x2e, 0x6b, 0x65, 0x79, 0x2e]
    let nonce3: Bytes = [
        0x6e, 0x6f, 0x6e, 0x63, 0x65, 0x2e, 0x6e, 0x6f, 0x6e, 0x63, 0x65, 0x2e]
    let aad3: Bytes = []
    let tag3: Bytes = [
        0xc9, 0x3a, 0xa6, 0x1f, 0xc3, 0xcc, 0x66, 0xa8, 0x19, 0xac, 0x96, 0xf6, 0xce, 0x36, 0x5a, 0xee]
    let plainText3: Bytes = [
    ...
    func test3() {
        ...
        XCTAssert(aead.decrypt(&t3, tag, aad3))
        XCTAssertEqual(t3, plainText3)
    }
    ...
    func test4() {
        ...
        XCTAssert(aead.decrypt(&t4, tag, aad4))
